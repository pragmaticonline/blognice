...
export function renderAffiliateOfferPage(
  ...
  const control = homepage
    ...
    .replace('<meta name="twitter:title" content="Blognice: Open-Source, Privacy-First Blogging Platform">', '<meta name="twitter:title" content="Save 10% on Blognice for 12 months">')
