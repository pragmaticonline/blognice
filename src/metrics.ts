...
export function metricsBeacon(consentRequired = true): string {
  ...
  return `<script>(function(){
    ...
    var preferences=document.getElementById("blognice-analytics-preferences");if(!preferences){preferences=document.createElement("button");preferences.type="button";preferences.className="blognice-analytics-preferences";preferences.textContent="Analytics preferences";document.body.appendChild(preferences)}preferences.addEventListener("click",showBanner);
