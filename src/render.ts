...
export function renderPost(
  ...
  const article = `<article class="post-page">
    ...
    <div class="byline">
      ...
      ${post.audio_key ? `<audio class="post-audio" data-narration controls preload="none" aria-label="Listen to this article" src="/media/${esc(post.audio_key)}">Your browser does not support audio playback.</audio><button class="post-audio-mobile" type="button" data-narration-mobile aria-label="Listen to this article"><span class="post-audio-mobile-icon" aria-hidden="true"><svg class="icon-play" viewBox="0 0 24 24"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg><svg class="icon-pause" viewBox="0 0 24 24" hidden><rect x="6" y="4" width="4" height="16" rx="1"></rect><rect x="14" y="4" width="4" height="16" rx="1"></rect></svg></span><span class="post-audio-mobile-label">Listen</span></button>` : ""}
    </div>
    ${featuredBlock}
