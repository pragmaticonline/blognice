...
test.before(async () => {
  ...
  await db.exec(`
    CREATE TABLE tenants (id INTEGER PRIMARY KEY, public_id TEXT UNIQUE, slug TEXT UNIQUE, custom_domain TEXT, title TEXT NOT NULL DEFAULT 'Test blog', description TEXT, footer_name TEXT, accent_color TEXT, topics_json TEXT, social_links_json TEXT, avatar_key TEXT, shard TEXT NOT NULL DEFAULT 'primary', deleted_at INTEGER);
