...
test.before(async () => {
  ...
  await db.exec(`
    ...
    CREATE TABLE accounts (id INTEGER PRIMARY KEY, email TEXT, billing_status TEXT DEFAULT 'inactive', billing_cancel_at_period_end INTEGER DEFAULT 0, crypto_paid_through INTEGER, status TEXT DEFAULT 'active');
