...
**Generation:** via `POST /api/v1/blogs/:blogId/images/generations` with the above prompt. Requires `API_TOKEN`. Not yet generated in this sandbox; to be added before Bob review.
...
- [ ] Bob AI review complete — pending draft publish
